...
# # input_prompt1="""You are an experienced HR with Tech experience in the field of any one job role fromData Science ,Full stack ,web development,Big Data Engineering,DEVOPS,Data Analyt,your task  is to review the provided resume against the job description for these profiles.
# # please share your professional evaluation on whether the candidate's profile aligns with role.
# # Highlight the strength and weaknesses of the applicant in relation to the specified job decription"""


# # input_prompt3="""You are an Skilled ATS(Application Tracking System) scanner with a deep understanding of any one job role Data Science,Full stack ,web development,Big Data Engineering,DEVOPS,Data Analyt and deep ATS functionality.
# # Your task is to evaluate the resume against the provided job description.Give me the percentage match if the resume matches the job description.First the output should come as percentage and then keywords missing and last final thoughts."""
...
# def input_pdf_setup(uploaded_file):
#     if uploaded_file is not None:
#         # Ensure you set the poppler path correctly
#         poppler_path = "C:/ProgramData/chocolatey/lib/poppler/tools"
